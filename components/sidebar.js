                ...
                >
                    <Flex w="100%" align="center" pl={2} pb={2} flexDir="row">
                        ...
                        <Flex w="100%" flexDir="column" color="white">
                            <Text pl={2} fontSize="sm" fontWeight="semibold">Secretaría General</Text>
                            <Text pl={2} fontSize="sm" fontWeight="light">secgral@unicauca.edu.co</Text>
                        </Flex>
                        <Icon as={ BsThreeDotsVertical } fontSize="xl" color="#FFF" ml={2} mr={2}/>
                    </Flex>
                </Flex>
